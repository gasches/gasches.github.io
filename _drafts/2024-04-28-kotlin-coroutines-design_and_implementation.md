...
Мы изучили текущую ситуацию с поддержкой асинхронного программирования в различных языках и сосредоточились на корутинах как одном из наиболее гибких средств для её реализации.
